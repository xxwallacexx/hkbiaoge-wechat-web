...
// must not be localized — PlanDataTable shows/pins columns by these ids. The DEFERED 現金價值
// tab is identical in shape to the coupon premium table; the cumulative column's `id`
// (累計保証現金) intentionally differs from its displayed header (週年紅利(累積)). Both
// 提款(年末)/提款(年初) edit the same backend withdrawal column.
export const premiumColumns: ColumnDef<PlanData>[] = [
  ...
  },
  {
    accessorKey: "週年紅利及利息",
    id: "週年紅利及利息",
    header: rightHeader("週年紅利及利息"),
    cell: plainCell("週年紅利及利息"),
  },
  {
    accessorKey: "終期分紅(現金)",
    id: "終期分紅(現金)",
