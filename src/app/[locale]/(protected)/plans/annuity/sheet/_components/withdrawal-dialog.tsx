...
/**
 * The per-row withdrawal cell: a button showing the current withdrawal that opens a dialog to
 * edit it. `period` (the row's 年度) is supplied by the column. The trigger ref is handed to the
 * form so it can close the dialog on success.
 */
