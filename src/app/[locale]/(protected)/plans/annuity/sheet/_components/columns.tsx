...
// must not be localized — PlanDataTable shows/pins columns by these ids. This is the GENERAL
// (investment-style) single table; 現金提取 is the withdrawal column. 退保 is rendered plain:
// the webview tested the negative flag against 終期分紅(現金), a key that doesn't exist in the
// GENERAL grid, so the value was always black — preserved here.
export const columns: ColumnDef<PlanData>[] = [
  ...
  },
  {
    accessorKey: "額外利息",
    id: "額外利息",
    header: rightHeader("額外利息"),
    cell: signedCell("額外利息"),
  },
  {
    accessorKey: "特別回報",
    id: "特別回報",
