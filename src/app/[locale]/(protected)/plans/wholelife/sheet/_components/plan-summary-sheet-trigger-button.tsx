...
/** Bottom-bar button opening a read-only summary: company badge, plan name, and the
 * client's age / term / health standard / region / premium. */
export function PlanSummarySheetTriggerButton({
  ...
  basicInfo: WholelifePlanSheetBasicInfo;
  sheetInfo: WholelifePlanSheetInfo;
  cal: PlanCal;
}) {
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-[22px] border bg-white p-4 sm:p-10">
            ...
            <div className="space-y-4">
              ...
              <Data field={t("healthStandard")} value={sheetInfo.health} />
              <Data field={t("region")} value={sheetInfo.area} />
              <Data
                field={t("premium")}
