...
// must not be localized — PlanDataTable shows/pins columns by these ids. The 提款 columns
// only carry data when the plan's param has a `withdrawalCol` (the table hides them
// otherwise, since their ids won't be in `premiumHeaders`).
