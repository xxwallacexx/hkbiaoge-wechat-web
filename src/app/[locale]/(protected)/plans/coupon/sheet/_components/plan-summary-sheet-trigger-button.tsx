 ...
 * client's age / term / dividend option / premium. */
export function PlanSummarySheetTriggerButton({
  ...
  basicInfo: CouponPlanSheetBasicInfo;
  sheetInfo: CouponPlanSheetInfo;
  cal: PlanCal;
}) {
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-[22px] border bg-white p-4 sm:p-10">
            ...
            <div className="space-y-4">
              ...
              <Data field={t("dividendChoice")} value={sheetInfo.dividend} />
              <Data
                field={t("premium")}
