...
// must not be localized — PlanDataTable shows/pins columns by these ids. The cumulative
// column's `id` (累計保証現金) intentionally differs from its displayed header
// (週年紅利(累積)) — this mirrors the webview coupon columns verbatim.
