...
// must not be localized. Two columns intentionally have an `id` that differs from their
// displayed header / read key — this mirrors the webview coupon columns verbatim (the
// 累計保証現金 column shows header 週年紅利(累積); the 週年紅利及利息 column shows and reads
// 終期分紅(身故)).
